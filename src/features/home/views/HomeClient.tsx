    ...
    <AuthGuard>
      <div className={`page-container ${styles.homeContainer}`}>
        ...
        <div className={styles.menuGrid}>
          ...
          <Link href="/settlement" className={`${styles.menuCard} ${styles.cardSettlement}`}>
            <span className={styles.cardIcon}><i className="fa-solid fa-hand-holding-dollar"></i></span>
            <span className={styles.cardTitle}>ワリカン</span>
          </Link>
          <Link href="/ideal-property" className={`${styles.menuCard} ${styles.cardIdealProperty}`}>
            <span className={styles.cardIcon}><i className="fa-solid fa-house-chimney-window"></i></span>
            <span className={styles.cardTitle}>理想の物件</span>
          </Link>
          <Link href="/budget" className={`${styles.menuCard} ${styles.cardBudget}`}>
            <span className={styles.cardIcon}><i className="fa-solid fa-wallet"></i></span>
            <span className={styles.cardTitle}>家計簿</span>
          </Link>
          <Link href="/memo" className={`${styles.menuCard} ${styles.cardMemo}`}>
